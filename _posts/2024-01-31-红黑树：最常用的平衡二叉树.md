...
![](/assets/img/images/red_black_tree_example_1.png){: width="672" height="89" }
...
![](/assets/img/images/red_black_tree_rotate_1.png){: width="672" height="89" }

在这种情况下，我们可以沿用 AVL 中的单次旋转（通过交换 P 与 G 的位置与颜色），来改变这部分的结构，如下图所示：

![](/assets/img/images/red_black_tree_rotate_2.png){: width="672" height="89" }
...
![](/assets/img/images/red_black_tree_rotate_3.png){: width="672" height="89" }
...
![](/assets/img/images/red_black_tree_prelocate_up.png){: width="672" height="89" }
...
![](/assets/img/images/red_black_tree_insert_example_1.png){: width="672" height="89" }

可是，这时显然没完，节点 50 和节点 60 均为红色，违背了红黑树的特性 3，于是我们执行旋转操作，操作后的树就如下图所示：

![](/assets/img/images/red_black_tree_insert_example_2.png){: width="672" height="89" }

我们从节点 50 处继续向下遍历，直到将节点插入到指定的位置：

![](/assets/img/images/red_black_tree_insert_example_3.png){: width="672" height="89" }

此时，很多人可能会说，那如果我们继续插入 47，这在插入后不久违背原则了吗？这也简单，插入后如果违背特性（插入节点的父节点为红色），直接旋转就好了，继续插入 47 后树就长这样：

![](/assets/img/images/red_black_tree_insert_example_4.png){: width="672" height="89" }
...
![](/assets/img/images/red_black_tree_deletion_1.png){: width="672" height="89" }

但如果说兄弟节点 T 下面有一个节点是红色的，单纯的颜色互换就行不通了，因为这会违背特性 3，这时我们就需要执行旋转操作：

![](/assets/img/images/red_black_tree_deletion_2.png){: width="672" height="89" }

![](/assets/img/images/red_black_tree_deletion_3.png){: width="672" height="89" }
