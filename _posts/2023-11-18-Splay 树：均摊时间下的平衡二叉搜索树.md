...
![](/assets/img/images/splay_1.png){: width="372" height="89" }

在这个例子中，当我们去获取 2 这个节点的信息，树的结构就会被调整成下图，可以很清晰地看到调整之后的树的整体的深度变小了，比如之前 4 这个节点要通过 16 次操作才能访问到，但是现在仅需 8 次操作：

![](/assets/img/images/splay_2.png){: width="372" height="89" }

我们继续去获取 3 的节点信息，就会得到下图：

![](/assets/img/images/splay_3.png){: width="372" height="89" }

然后是获取 4 的节点信息：

![](/assets/img/images/splay_4.png){: width="372" height="89" }
...
![](/assets/img/images/splay_zig.png){: width="372" height="89" }
...
![](/assets/img/images/splay_zig_zig.png){: width="372" height="89" }
...
![](/assets/img/images/splay_example1.png){: width="372" height="89" }

下一步我们要去的是节点 25，也就是我们之前讨论的第一种情况的对称情况，所以我们可以将树变成下面这样：

![](/assets/img/images/splay_example2.png){: width="372" height="89" }

然后我们要去到节点 25，也就是我们之前讨论的第二种情况，旋转后可得：

![](/assets/img/images/splay_example3.png){: width="372" height="89" }

最后我们要去到节点 18，这里还是第一种情况的对称情况，旋转可得：

![](/assets/img/images/splay_example4.png){: width="372" height="89" }

虽然我们没有找到 19，但是我们的遍历终止在 18 处，这时我们进行最后的拼接就得到最后的树：

![](/assets/img/images/splay_example5.png){: width="372" height="89" }
