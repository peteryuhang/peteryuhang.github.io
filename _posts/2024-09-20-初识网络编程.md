...
![](/assets/images/client_server_programming_model.png){: width="472" height="129" }
...
![](/assets/images/hardware_orgnaization_of_a_network_host_csapp_ch11.png){: width="472" height="129" }

多台主机可以通过集线器（Hub）构成一个以太网段（Ethernet segment），如下图所示：

![](/assets/images/ethernet_segment_csapp_ch11.png){: width="472" height="129" }

需要注意的是，集线器会不加分辨地将一端的收到的数据复制到其他所有端口上，因此这里的每台主机（Host）都能看到每个位。

多个以太网段又可以被网桥（bridge）来连接形成较大的局域网（LAN）：

![](/assets/images/bridged_ethernet_segments_csapp_ch11.png){: width="472" height="129" }

一个局域网可以有很多网桥，网桥中运行着一些智能的分布式算法，它们会根据传过来的数据决定传递的方向。

局域网可以被特定的主机——路由器（router）相连而形成广域网（WAN）：

![](/assets/images/a_small_internet_csapp_ch11.png){: width="472" height="129" }
...
![](/assets/images/how_data_travel_from_one_host_to_another_on_an_internet_csapp_ch11.png){: width="472" height="129" }
...
![](/assets/images/hardware_and_software_organization_of_an_internet_app_csapp_ch11.png){: width="472" height="129" }
...
![](/assets/images/subset_of_the_internet_domain_name_hierarchy_csapp_ch11.png){: width="472" height="129" }
...
![](/assets/images/anatomy_of_an_internet_connection_csapp_ch11.png){: width="472" height="129" }
...
![](/assets/images/overview_of_network_applications_based_on_the_sockets_interface_csapp_ch11.png){: width="472" height="129" }
...
![](/assets/images/roles_of_the_listening_and_connected_descriptors_csapp_ch11.png){: width="472" height="129" }
...
![](/assets/images/data_structure_returned_by_getaddrinfo_csapp_ch11.png){: width="472" height="129" }
