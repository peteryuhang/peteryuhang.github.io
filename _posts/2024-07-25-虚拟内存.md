...
![](/assets/img/images/memory_hierarchy_example.png){: width="472" height="129" }
...
![](/assets/img/images/a_system_that_uses_virtual_addressing.png){: width="472" height="129" }
...
![](/assets/img/images/how_a_VM_system_uses_main_memory_as_a_cache.png){: width="472" height="129" }
...
![](/assets/img/images/page_table_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/allocating_a_new_virtual_page.png){: width="472" height="129" }
...
![](/assets/img/images/VM_provide_page_level_memory_protection.png){: width="472" height="129" }
...
![](/assets/img/images/address_translation_with_a_page_table_csapp.png){: width="472" height="129" }

我们再来结合前面说的页命中和页缺失来看看具体步骤，首先是页命中：

![](/assets/img/images/operational_view_of_page_hit_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/operational_view_of_page_fault_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/integrating_VM_with_a_physical_address_cache_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/operational_view_of_TLB_hit.png){: width="472" height="129" }

![](/assets/img/images/operational_view_of_TLB_miss.png){: width="472" height="129" }

TLB 也是基于虚拟内存地址中的 VPN 部分来进行索引的，具体来说 VPN 被拆分成两部分，如下图所示：

![](/assets/img/images/virtual_address_used_to_access_TLB_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/a_two_level_page_table_hierarchy_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/address_translation_with_k_level_page_tables_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/addressing_for_small_memory_system_csapp.png){: width="472" height="129" }

我们假设每页的大小是 64 字节，另外 TLB 的情况如下图所示：

![](/assets/img/images/memory_system_TLB_eg_csapp.png){: width="472" height="129" }

还有页表：

![](/assets/img/images/memory_system_page_table_eg_csapp.png){: width="472" height="129" }

最后是内存：

![](/assets/img/images/memory_system_cache_eg_csapp.png){: width="472" height="129" }

现在假设说程序需要读取虚拟地址为 `0x03d4` 处的数据，首先内存地址单元（MMU）会发送请求到 TLB，TLB 会根据虚拟地址的 VPN 部分进行寻址，具体如下图所示：

![](/assets/img/images/memory_system_MMU_TLB_eg_csapp.png){: width="472" height="129" }

可以看到在 TLB 中的是缓存了页表元素的，我们直接可以拿到 PPN，为 `0x0D`，然后我们在就可以得到物理地址，通过物理地址来找到数据：

![](/assets/img/images/memory_system_PTE_PA_eg_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/the_core_i7_memory_system_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/summary_of_core_i7_address_translation_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/virtual_memory_of_a_linux_process_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/how_linux_organizes_virtual_memory_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/linux_page_fault_handling_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/a_share_object_ch9_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/a_private_copy_on_write_object_a_ch9_csapp.png){: width="472" height="129" }

但是当某个进程尝试着更改文件，拷贝就会发生，拷贝仅仅是针对这个进程，其他进程不受影响，并且只有更改的部分会被拷贝：

![](/assets/img/images/a_private_copy_on_write_object_b_ch9_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/how_the_loader_maps_areas_of_user_address_space_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/visual_interpretation_of_mmap_arguments_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/the_heap_ch9_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/allocating_and_freeing_blocks_with_malloc_and_free_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/format_of_a_simple_heap_block_csapp.png){: width="472" height="129" }

该区块用了四个字节来存储区块的基本信息，比如区块大小、以及该区块是否被分配。图中的 `Padding` 表示的是对齐区域。下图就是一个基于隐式空闲链表的例子：

![](/assets/img/images/organzing_the_heap_with_an_implicit_free_list_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/an_example_of_false_fragmentation_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/format_of_heap_block_that_uses_a_boundary_tag_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/coalescing_with_boundary_tags_case_1_csapp.png){: width="472" height="129" }

第二种情况，后一个区块是空闲的，前一个区块是分配的，这样就将后两个区块合并起来：

![](/assets/img/images/coalescing_with_boundary_tags_case_2_csapp.png){: width="472" height="129" }

第三种情况，前一个区块是空闲的，后一个区块是分配的，这样就将前两个区块合并起来：

![](/assets/img/images/coalescing_with_boundary_tags_case_3_csapp.png){: width="472" height="129" }

第四种情况，前后两个区块都是空闲的，直接将这三个区块都合并起来：

![](/assets/img/images/coalescing_with_boundary_tags_case_4_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/format_of_heap_blocks_that_use_doubly_linked_free_lists_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/a_garbage_collector_view_of_memory_as_a_directed_graph_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/integrating_conservative_garbage_collector_and_a_C_malloc_package_csapp.png){: width="472" height="129" }
...
![](/assets/img/images/mark_and_sweep_eg_csapp.png){: width="472" height="129" }
