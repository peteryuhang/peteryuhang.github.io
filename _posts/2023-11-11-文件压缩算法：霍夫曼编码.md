...
![](/assets/images/Huffman_code1.png){: width="372" height="89" }
...
![](/assets/images/Huffman_code2.png){: width="372" height="89" }
...
![](/assets/images/Huffman_code3.png){: width="372" height="89" }

我们首先将字符 `s` 和 `nl` 进行合并，并生成一个新的根节点，这样需要合并的树就少了一个：

![](/assets/images/Huffman_code4.png){: width="372" height="89" }

以此类推，我们可以将其他节点依照树的频率，依次合并：

![](/assets/images/Huffman_code5.png){: width="372" height="89" }

<br>

![](/assets/images/Huffman_code6.png){: width="372" height="89" }

<br>

![](/assets/images/Huffman_code7.png){: width="372" height="89" }

<br>

![](/assets/images/Huffman_code8.png){: width="372" height="89" }

<br>

![](/assets/images/Huffman_code9.png){: width="372" height="89" }
