...
![](/assets/img/images/memory_hierarchy_example.png){: width="372" height="89" }
...
![](/assets/img/images/x86_64_integer_registers.png){: width="372" height="89" }
...
![](/assets/img/images/illustration_of_stack_operation.png){: width="372" height="89" }
...
![](/assets/img/images/general_stack_frame_structure.png){: width="372" height="89" }
...
![](/assets/img/images/stack_frame_for_function_call_proc.png){: width="372" height="89" }
...
![](/assets/img/images/structures_in_c_example.png){: width="372" height="89" }
...
![](/assets/img/images/data_alignment_example_1.png){: width="372" height="89" }

可问题是，第三个数据成员 `j` 存放的地址并没有对齐，因此我们需要填补空档，让其对齐：

![](/assets/img/images/data_alignment_example_2.png){: width="372" height="89" }
...
![](/assets/img/images/media_registers_for_floating_point.png){: width="372" height="89" }
