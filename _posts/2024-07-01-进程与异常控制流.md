...
![](/assets/img/images/anatomy_of_an_exception.png){: width="472" height="129" }
...
![](/assets/img/images/exception_table_csapp_ch8.png){: width="472" height="129" }

异常表其实就是一个数组，每个元素是一个处理程序的地址。有了异常表，再借助运行时的寄存器，我们就可以定位到指定的异常处理程序：

![](/assets/img/images/generating_the_address_of_an_exception_handler_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/interrupt_handling_csapp_ch8.png){: width="472" height="129" }

可以看到的是，中断只会发生在当前指令执行完成后，程序仅仅是被暂停了，当中断处理完成后，程序继续正常执行，并且程序的状态均不受影响。

第二个种异常是 **陷阱（Trap）**，这种异常是由于程序主动调用异常处理程序所导致的，下图可以概括这一过程：

![](/assets/img/images/trap_handling_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/fault_handling_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/abort_handling_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/logical_control_flows_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/process_address_space_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/anatomy_of_a_process_context_switch_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/process_graph_for_the_eg_program_in_815_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/process_graph_for_a_nested_fork_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/signal_handling_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/foreground_and_background_process_group_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/handler_can_be_interrupted_by_other_handlers_csapp_ch8.png){: width="472" height="129" }
...
![](/assets/img/images/async_signal_safe_functions_csapp_ch8.png){: width="472" height="129" }
