...
![](/assets/img/images/%E5%A0%86.png){: width="372" height="89" }
...
![](/assets/img/images/%E5%A0%86_2.png){: width="372" height="89" }
...
![](/assets/img/images/%E5%A0%86%E7%9A%84%E8%A1%A8%E7%A4%BA.png){: width="372" height="89" }

数组带来的好处是空间的节省以及访问速度的提升，但是用数组来表示堆并没改变它原本的结构，那它又是如何做到在 `O(1)` 的时间获得极值的呢？

这里就不得不说堆中的元素的排列顺序了，把之前的图例用整形来表示，可以得到下面这个例子：

![](/assets/img/images/%E5%A0%86_3.png){: width="372" height="89" }
...
![](/assets/img/images/%E5%A0%86_insert.png){: width="372" height="89" }
...
![](/assets/img/images/%E5%A0%86_insert_2.png){: width="572" height="170" }

<br>

![](/assets/img/images/%E5%A0%86_insert_3.png){: width="572" height="170" }
...
![](/assets/img/images/%E5%A0%86_deleteMin.png){: width="572" height="170" }
...
![](/assets/img/images/%E5%A0%86_deleteMin_2.png){: width="572" height="170" }

<br>

![](/assets/img/images/%E5%A0%86_deleteMin_3.png){: width="572" height="170" }
