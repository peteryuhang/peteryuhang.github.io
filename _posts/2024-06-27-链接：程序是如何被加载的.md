...
![](/assets/img/images/linker_compilation_system.png){: width="472" height="129" }
...
![](/assets/img/images/typical_elf_relocatable_object_file.png){: width="472" height="129" }
...
![](/assets/img/images/linking_with_static_library.png){: width="472" height="129" }
...
![](/assets/img/images/typical_elf_executable_object_file.png){: width="472" height="129" }
...
![](/assets/img/images/linux_x86-64_run_time_memory_image_executable_obj_file.png){: width="472" height="129" }
...
![](/assets/img/images/dynamic_linking_with_shared_libraries.png){: width="472" height="129" }
...
![](/assets/img/images/using_the_GOT_to_reference_a_global_variable.png){: width="472" height="129" }
...
![](/assets/img/images/using_PLT_and_GOT_to_call_external_functions.png){: width="472" height="129" }
