...
![](/assets/images/typical_kernel_data_structures_for_open_files.png){: width="472" height="129" }

在这个框架下，文件共享成为了可能，比如下面这个例子就是两个不同的文件描述符指向同一个磁盘文件：

![](/assets/images/typical_kernel_data_structures_for_files_sharing.png){: width="472" height="129" }
...
![](/assets/images/how_a_child_process_inherit_parents_open_file.png){: width="472" height="129" }
...
![](/assets/images/kernel_data_structures_after_redirecting_standard_output_by_calling_dup2.png){: width="472" height="129" }

## 总结

关于上面介绍的 I/O 的相关函数，下图可以说明它们之间的关系：

![](/assets/images/relation_between_standard_io_unix_io_and_rio.png){: width="472" height="129" }
